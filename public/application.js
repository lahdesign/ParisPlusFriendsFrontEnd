...
var createProposal = function createProposal(data) {
  return $.ajax({
...
var showProposals = function showProposals() {
  return $.ajax({
    url: config.apiUrl + '/proposals/',
    method: 'GET',
    headers: {
...
var updateProposal = function updateProposal(data) {
  return $.ajax({
...
var deleteProposal = function deleteProposal(proposalId) {
  return $.ajax({
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://shrouded-wave-32013.herokuapp.com/',
...
var proposalEvents = __webpack_require__(11);
...
var proposalApi = __webpack_require__(5);
var proposalUi = __webpack_require__(13);

var onCreateProposal = function onCreateProposal(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  proposalApi.createProposal(data).then(proposalUi.createProposalSuccess).catch(proposalUi.failure);
};

var onShowProposals = function onShowProposals(event) {
  event.preventDefault();
  $('.content').html('');
  proposalApi.showProposals().then(proposalUi.showProposalSuccess).catch(proposalUi.onError);
};

var onUpdateProposal = function onUpdateProposal(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  proposalApi.updateProposal(data).then(proposalUi.updateProposalSuccess).catch(proposalUi.failure);
};
...
var onClearProposal = function onClearProposal(event) {
  event.preventDefault();
...
module.exports = {
  ...
  // onGetProposals,
  // onDeleteProposal,
  onClearProposal: onClearProposal,
...
var store = __webpack_require__(3);
var proposalTemplate = __webpack_require__(14);
var proposalApi = __webpack_require__(5);
...
var createProposalSuccess = function createProposalSuccess(data) {
...
var showProposalSuccess = function showProposalSuccess(data) {
  console.log(data);
  var htmltemplate = proposalTemplate({ proposals: data.proposals });
  $('.content').append(htmltemplate);
  $('.delete').on('click', onDeleteProposal);
};

var updateProposalSuccess = function updateProposalSuccess(data) {
  $('#message').text('Example successfully created');
  $('#message').css('background-color', 'green');
  store.proposal = data.proposal;
...
var onDeleteProposal = function onDeleteProposal(event) {
  event.preventDefault();
  var proposalId = $(event.target).closest('ul').attr('data-id');
  // console.log("delete: " + boardgameId)
  proposalApi.deleteProposal(proposalId).then(onDeleteProposalSuccess);
};

var onDeleteProposalSuccess = function onDeleteProposalSuccess() {
...
module.exports = {
  createProposalSuccess: createProposalSuccess,
  showProposalSuccess: showProposalSuccess,
  updateProposalSuccess: updateProposalSuccess,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<h1><b>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.project_title : stack1), depth0))
    + "</b></h1>\n<h3>Question 1: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.question_one : stack1), depth0))
    + "</h3>\n<h3>Question 2: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.question_two : stack1), depth0))
    + "</h3>\n<h3>Question 3: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.question_three : stack1), depth0))
    + "</h3>\n\n<ul data-id=\""
    ...
    + "   </li>\n   <li><button class=\"delete\" type=\"submit\">DELETE</button></li>\n </ul>\n</div>\n\n\n";
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.proposals : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "\n";
...
var onSignUp = function onSignUp(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signUp(data).then(authUi.onSignUpSuccess).catch(authUi.onSignUpFailure);
};
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  $('#userInfo').show();
  var data = getFormFields(event.target);
  authApi.signIn(data).then(authUi.onSignInSuccess).catch(authUi.onSignInFailure);
  $('#buildProposal').show();
};
...
var onchangePassword = function onchangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.changePassword(data).then(authUi.changePasswordSuccess).catch(authUi.failure);
};
var onSignOut = function onSignOut(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signOut(data).then(authUi.onSignOutSuccess).catch(authUi.failure);
};
...
module.exports = __webpack_require__.p + "0282f446daf42c6f2019c13ad084b107.gif";
